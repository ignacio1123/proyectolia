            ...
            <div class="w-full h-full flex justify-center items-center">
                <div class="w-[89%] flex flex-col">
                    ...
                    <div class="w-full">
                            ...
                            <table class="table-auto w-full text-left text-sm text-gray-700">
                                <thead class="bg-black/90">
                                    <tr>
                                        ...
                                        <th class="border-b py-2 px-4 text-white">Agregar Retroalimentación</th>
                                    </tr>
                                </thead>
                                <tbody class="p-2">
                                            ...
                                            <td class="py-2 px-4">
                                                ...
                                                <div id="authentication-modal-<?php echo $solicitud['id_solicitud']; ?>" tabindex="-1" aria-hidden="true"
                                                    ...
                                                    <div class="relative w-[60%] max-h-[90vh] p-6 bg-white rounded-lg shadow-lg">
                                                        ...
                                                        <form method="POST" action="" id="form-estado-<?php echo $solicitud['id_solicitud']; ?>">
                                                            ...
                                                            <div class="flex gap-4 mt-4">
                                                                <button type="submit" onclick="setAccion('<?php echo $solicitud['id_solicitud']; ?>', 'Aprobar')"
                                                                    class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg w-full">
                                                                    Aprobar
                                                                </button>
                                                                <button type="submit" onclick="setAccion('<?php echo $solicitud['id_solicitud']; ?>', 'Rechazar')"
                                                                    class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg w-full">
                                                                    Rechazar
                                                                </button>
                                                                <button type="submit" onclick="setAccion('<?php echo $solicitud['id_solicitud']; ?>', 'Pendiente')"
                                                        ...
                                                        <?php
                                                        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id_solicitud']) && isset($_POST['accion'])) {
                                                            $accion = $_POST['accion'];
                                                            $id_solicitud = $_POST['id_solicitud'];

                                                            $estado = ($accion === 'Aprobar') ? 'Aprobada' : (($accion === 'Rechazar') ? 'Rechazada' : (($accion === 'Pendiente') ? 'Pendiente' : null));
                                                        ...
                                                        <script>
                                                            function setAccion(idSolicitud, accion) {
                                                                ...
                                                                const form = document.getElementById('form-estado-' + idSolicitud);
                                                                ...
                                                                fetch('', {
                                                                    ...
                                                                    .then(data => {
                                                                        ...
                                                                        const estadoCell = document.querySelector(`#estado-${idSolicitud}`);
                                                                        estadoCell.textContent = accion;
                        ...
                        <td>
                            <button data-modal-target="authentication-modal-<?php echo $solicitud['id_solicitud']; ?>-2"
                                data-modal-toggle="authentication-modal-<?php echo $solicitud['id_solicitud']; ?>-2"
                                class="bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg text-sm px-5 py-2.5"
                                type="button">
                                Agregar Retroalimentación
                            </button>

                            <div id="authentication-modal-<?php echo $solicitud['id_solicitud']; ?>-2" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 flex justify-center items-center bg-opacity-50">
                                <div class="relative w-[50%] p-6 bg-white rounded-lg shadow-lg">
                                    <h3 class="text-xl font-semibold text-gray-900">Agregar Retroalimentación para Proyecto: <?php echo htmlspecialchars($solicitud['id_solicitud']); ?></h3>
                                    <form method="POST" action="">
                                        <input type="hidden" name="id_solicitud" value="<?php echo $solicitud['id_solicitud']; ?>">
                                        <textarea name="Retroalimentación" class="w-full p-2 border rounded-lg" rows="5" placeholder="Escribe tu Retroalimentación..."></textarea>
                                    ...
                                    <button type="button" class="mt-4 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg p-2" data-modal-hide="authentication-modal-<?php echo $solicitud['id_solicitud']; ?>-2">
                                        Cerrar
                                    </button>
                                </div>
                            </div>
                            ...
                            <?php
                                        // Procesar el formulario para agregar acotaciones
